    ...
    <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="col-lg-4 col-md-6 portfolio-item filter-app">
        <div class="portfolio-wrap">
          <img src="{{ asset('assets/img/portfolio/portfolio_1.png') }}" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Pet Tracking Management System</h4>
            <p>Pet Tracking Mangement System Using PHP Laravel Framework and Javascript</p>
            <div class="portfolio-links">
              <a href="{{ asset('assets/img/portfolio/portfolio_1.png') }}" data-gallery="portfolioGallery" class="portfolio-lightbox" title="App 1"><i class="bx bx-plus"></i></a>
